...
class Robotarium:
    ...
    def get_state(self, model_name):
        ...
        model_linear, model_angular, model_pose0 = 0, 0, 0
    ...
    def reset_test_agent_state(self, ddr_list):
        """
        ...
        try:
            ...
            for i, ddr in enumerate(ddr_list):
                ...
                quart = tf.transformations.quaternion_from_euler(0, 0, 1.5)
    ...
    def reset_test_10agents_state(self, ddr_list):
        """
        :param ddr_list: 列表， 元素为car类
        :return:
        """
    ...
    def reset_test_agent_random_state(self, ddr_list):
        """
        随机重置agent状态，用于100次test。
        :param ddr_list: 列表， 元素为car类
        :return:
        """
        rospy.wait_for_service('/gazebo/set_model_state')
        try:
            ...
            for i, ddr in enumerate(ddr_list):
                ...
                if i == 0:
                    # x1, y1 = 0.5 * np.random.rand()+3, 0.5 * np.random.rand()+0.5 # 3agents
                    # x1, y1 = 1 * np.random.rand()+2, 0.5 * np.random.rand()+1.5 # 3agents
                    x1, y1 = 1 * np.random.rand()+1.5, 0.5 * np.random.rand()+3,  # 3agents,动态障碍
                    # x1, y1 = 1 * np.random.rand()+2, 1 * np.random.rand()+1,  # 3agents,动态障碍
                    # x1, y1 = 0.5 * np.random.rand()+0.5, 0.5 * np.random.rand()+1
                    # x1, y1 = 1 * np.random.rand()+1, 1 * np.random.rand()+1
                    my_model.model_state.pose.position.x = x1
                    my_model.model_state.pose.position.y = y1
                    my_model.model_state.pose.position.z = 0

                elif i == 1:
                    # x1, y1 = 1 * np.random.rand()-1, 0.5 * np.random.rand()+0.5  # 3agents
                    # x1, y1 = 0.5 * np.random.rand()+2., 0.5 * np.random.rand()+1.5  # 3agents
                    x1, y1 = 0.5 * np.random.rand()+1.5, 0.5 * np.random.rand()+1.5  # 3agents,动态障碍
                    # x1, y1 = 1 * np.random.rand()+0, 1 * np.random.rand()+1  # 3agents,动态障碍
                    # x1, y1 = 0.5 * np.random.rand()+3., 0.5 * np.random.rand()+3.  # 10agents
                    # x1, y1 = 1 * np.random.rand()+3., 1 * np.random.rand()+3.  # 10agents
                    # x1, y1 = 0, 1
                    my_model.model_state.pose.position.x = x1
                    my_model.model_state.pose.position.y = y1
                    my_model.model_state.pose.position.z = 0
                elif i == 2:
                    x1, y1 = 2 * np.random.rand()-1 , -1 * np.random.rand()   # 3个ugv测试时使用
                    # x1, y1 = -0.5 * np.random.rand()-0.5, 0.5 * np.random.rand()+1
                    # x1, y1 = -0.5 * np.random.rand()-3, 0.5 * np.random.rand()+0.5
                    # x1, y1 = -1 * np.random.rand()-1, 1 * np.random.rand()+1
                    ...
                    # x1, y1 = -0.5 * np.random.rand()-3, 0.5 * np.random.rand()+3
                    x1, y1 = -1 * np.random.rand()-1, 1 * np.random.rand()+3.
                    my_model.model_state.pose.position.x = x1
                    my_model.model_state.pose.position.y = y1
                    my_model.model_state.pose.position.z = 0
                elif i == 4:
                    ...
                    x1, y1 = -0.5 * np.random.rand()-0.5, 1 * np.random.rand() - 0.5
                    my_model.model_state.pose.position.x = x1
                    my_model.model_state.pose.position.y = y1
                    my_model.model_state.pose.position.z = 0
                elif i == 9:
    ...
    def reset_target(self, target_pos_list):
        """
